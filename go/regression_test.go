...
// TestGuestCallEndAlignedResponse verifies that DirectGuest.SendGuestCall correctly handles
// negative RespSize (end aligned data).
func TestGuestCallEndAlignedResponse(t *testing.T) {
	shmName := "EndAlignedRespSHM"
    UnlinkShm(shmName)
